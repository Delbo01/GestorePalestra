...
public class ControllerCliente {
    ...
    private ControllerCorso calendario;
    ...
    public ControllerCliente(Cliente cliente, GestoreAbbonamenti gestoreAbbonamenti, GestorePT gestorePT, ControllerCorso calendario) {
